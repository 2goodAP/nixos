  ...
  home-manager.users."${uname}" = {inputs', ...}: {
    ...
    in {
      ...
      roboquest = {
        ...
        exec =
          ''env GAMEID=692890 umu-launch -emt "Proton 6.3"''
          + " ${wineDir}/Games/Roboquest RoboQuest.exe";
        genericName = "Game";
      ...
      #   exec =
      #     "env GAMEID=588650 umu-launch -emx"
      ...
      #   exec =
      #     "env GAMEID=1145360 umu-launch -em"
      ...
      #   exec =
      #     "env GAMEID=367520 umu-launch -em"
      ...
      #   exec =
      #     "env GAMEID=1057090 umu-launch -emx"
      #     + " ${wineDir}/Games/Ori_and_the_Will_of_the_Wisps oriwotw.exe";
      #   genericName = "Game";
      ...
      #   exec =
      #     ''env PROTON_ENABLE_NVAPI=1 WINEDLLOVERRIDES="dinput8=n,b" GAMEID=1174180''
      ...
      #   exec =
      #     "env GAMEID=1545560 umu-launch -em"
      #     + " ${wineDir}/Games/Shadow_Gambit_The_Cursed_Crew ShadowGambit_TCC.exe";
      #   genericName = "Game";
